...
class BaseCommand:
    ...
    def execute(self, *args, **options):
        ...
        if self.requires_system_checks and not options["skip_checks"]:
            # note :: if it is considered usefull to do check before running a command
            #  it should be then readded
            raise CommandError(
                "Checks are not activated since it was considered unecessary"
            )
